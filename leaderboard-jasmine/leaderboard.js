...
PlayersService = {
  ...
  addPlayer: function (playerName,currentUserId) {
      Players.insert({
          name: playerName,
          score: 0,
...
if (Meteor.isClient) {
  ...
  Template.addPlayerForm.events({
    'submit form': function(event){
      ...
      var playerNameVar = event.target.Name.value;
      var currentUserId = Meteor.userId();
      PlayersService.addPlayer(playerNameVar,currentUserId);
    }
  });
}
